...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "FeedbackDiscipline.Android.dll" comes first in this list. */
		"FeedbackDiscipline.Android.dll",
